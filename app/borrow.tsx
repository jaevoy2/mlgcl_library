    ...
    if (scannedBook != null) {
      try {
        ...
        if (origin != qrOrigin) {
          return Alert.alert(
            "Invalid",
            "Invalid QR code. Please scan a valid user QR code.",
            [
              {
                text: "OK",
                onPress: () => {
        ...
        Alert.alert(
          "Error",
          error.message || "Failed to validate user QR code.",
          [
            {
              text: "OK",
              onPress: () => {
              ...
              >
                <View>
                  ...
                  >
                    <View>
                      <View>
                        <Text style={{ opacity: 0.7 }}>Publication Year</Text>
                      ...
                      <View style={{ marginTop: 10 }}>
                        <Text style={{ opacity: 0.7 }}>Author</Text>
                    ...
                    <View>
                      <View>
                        <Text style={{ opacity: 0.7 }}>Available Copy</Text>
                        <Text style={{ fontSize: 16, fontWeight: "800" }}>
                          {bookCopies ?? 0}
                        </Text>
                      </View>
                      <View style={{ marginTop: 10 }}>
                        <Text style={{ opacity: 0.7 }}>Reserved</Text>
                        <Text style={{ fontSize: 16, fontWeight: "800" }}>
                          {reserved}
                        </Text>
                      </View>
                      <View style={{ marginTop: 10 }}>
                        <Text style={{ opacity: 0.7 }}>Borrowed</Text>
                        <Text style={{ fontSize: 16, fontWeight: "800" }}>
                          {borrowed}
                        </Text>
                      </View>
