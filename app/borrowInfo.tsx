        ...
        Alert.alert("Success", response.success, [
          {
            ...
            onPress: () => {
              {
                (setBorrowedBook(null), router.replace("/dashboard"));
              }
            },
          },
        ]);
        ...
        >
          <View>
            <View>
              ...
              >
                ...
                <View style={{ alignItems: "flex-end" }}>
                  ...
                  <Text style={{ fontWeight: "800", fontSize: 16 }}>
                    {borrowedBook?.bookClassification}
                  </Text>
                </View>
              </View>
              <View
            ...
            >
              ...
              >
                <Text style={{ opacity: 0.5, fontWeight: "800" }}>
                  Available
                </Text>
                <Text style={{ fontWeight: "800", fontSize: 16 }}>
            ...
            <View style={{ marginTop: 50 }}>
              <Text style={{ opacity: 0.5, fontSize: 18, fontWeight: "800" }}>
                Borrower Details
              </Text>
              <View
                style={{
              ...
              >
                <Image
                  source={{ uri: borrowedBook?.userImage }}
                ...
                <View style={{ width: "60%" }}>
                  ...
                  >
                    {borrowedBook?.userType.toUpperCase()}
                  </Text>
                </View>
              </View>
            </View>
          ...
          <View>
            ...
            <TouchableOpacity
              onPress={() => {
                (setBorrowedBook(null), router.replace("/(tabs)/dashboard"));
              }}
